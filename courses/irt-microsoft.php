...
<!--End Of Style --> 
  ...
  <!-- Top Navigation -->
    <div class="container-fluid  navigation">
      ...
      <ul class="nav navbar-nav  navbar-right">
        ...
        <li class="active"><a href="https://www.facebook.com/admin.irt" style=""><img src="images/facebookblack.png" style="height:23px"></a></li>
    ...
    <nav class="navbar navbar-default navigation" data-spy="affix" data-offset-top="50">
      ...
      <li><a href="#" style="">ADVISORIES</a> </li>
                ...
                <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="irt-redhat.php">Red Hat Linux</a></li>
                        <li><a href="irt-cisco.php">CISCO</a></li>
                        <li><a href="irt-microsoft.php">Microsoft</a></li>
                        <li><a href="irt-aws.php">AWS</a></li>
                    </ul>
                </li>
                <!-- #### -->
  ...
  <!-- ..........Cover Image ............. -->
        ...
        <div>
            <img src="images/microsoftcover.jpg" style="width:100%;height:400px">
        </div>
              ...
              <div class="container">
                 ...
                 <!-- Row First -->
                   <div class="row">
                       ...
                       <div class="col-sm-2">
                           <img src="images/microsoftassociate.png" style="height:120px;margin-top:25px;width:180px" class="img-responsive center-block">
                       </div>
                       
                       <div class="col-sm-10">
                         <h3>Microsoft Certified Solution Associate</h3>
                           <p style="text-align: justify;font-size: 17px">
                              Microsoft Certified Solution Associate is a Training that validates IT professional and developer technical expertise through rigorous, industry-proven, and industry-recognized exams. MCP exams cover a wide range of Microsoft products, technologies, and solutions. MCSA is a certification program intended for people who seek entry-level jobs in an IT environment. MCSA is a prerequisite for more advanced Microsoft certifications.
                           </p>
                       </div>
                   </div>
                ...
                <!-- Row Second -->
                   <div class="row">
                       ...
                       <div class="col-sm-2">
                           <img src="images/microsoftsolutionexpert.jpg" style="height:120px;margin-top:25px" class="img-responsive center-block">
                       </div>
                       
                       <div class="col-sm-10">
                         <h3>Microsoft Certified Solution Expert</h3>
                           <p style="text-align: justify;font-size: 17px">
                              ...
                              <p style="text-align: justify;font-size: 17px">
                                 ...
                                 An IT professional who has earned the Red Hat Certificate of Expertise in Hybrid Cloud Management has demonstrated the knowledge, skills, and abilities to perform a number of tasks using Red Hat CloudForms.
                              </p>
                ...
                <!-- Row Third -->
                   <div class="row">
                       ...
                       <div class="col-sm-2">
                           <img src="images/microsofttechnologyassociate.png" style="height:120px;margin-top:25px" class="img-responsive center-block">
                       </div>
                       
                       <div class="col-sm-10">
                         <h3>Microsoft Technology Associate (MTA)</h3>
                           <p style="text-align: justify;font-size: 17px">
                               Is an introductory Microsoft certification for individuals considering a career in technology. MTA certification addresses a wide spectrum of fundamental technical concepts, assesses and validates your core technical knowledge, and enhances your technical credibility.
                             </p>
