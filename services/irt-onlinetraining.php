...
<!--End Of Style --> 
            ...
            <ul class="nav navbar-nav navbar-right">
               ...
               <!-- Drop Down Associates -->
                ...
                <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="irt-corporate.php">Corporate Training</a></li>
                        <li><a href="irt-onlinetraining.php">Technical Support</a></li>
                        <li><a href="irt-technical.php">Online Training</a></li>
                    </ul>
                </li>
                <!-- #### -->
  ...
  <!--++++++++++++++++NAvigation Bar Ends Here++++++++++++++++ -->
        ...
        <div class="jumbotron" style="">
            <img src="images/onlinetrainingcover.jpg" style="width:100%;height:450px" class="img-responsive center-block">
        </div>

        <div class="jumbotron">
               <div class="container">
                   <img src="images/onlinetrainingpng.jpg" style="height:60px" class="img-responsive center-block">
                   <h2 style="text-align: center">Technical Support</h2>
               </div>
               <br><br>
               <div class="container">
                   ...
                   <div class="row">
                       ...
                       <div class="col-sm-3">
                           <img src="images/technicalsupport1.png" style="height:120px" class="img-responsive center-block">
                       </div>
                ...
                <!-- Row second -->
                   <div class="row">
                       ...
                       <div class="col-sm-2">
                           <img src="images/trainingobjectivepage.png" style="height:120px;margin-top: 20px" class="img-responsive center-block">
                       </div>
